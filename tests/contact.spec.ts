...
test('Contact URL preserves accents, line breaks and optional investment', () => {
  const message = buildMessage({environment:'Cozinha',city:'  São José, SC  ',measures:'Ainda não sei',blueprint:'Tenho referências ou imagem de IA',timing:'Ainda não sei',budget:''});
